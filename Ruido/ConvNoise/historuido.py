...
#Matriz de ruido
Noise = np.random.normal(0,4,size=(B,B))
...
sc, mc = AjustarGaussiana(ConvNoise,'Histograma de ruido convolucionado','histoconv')
...
file.write(
    ...
    r'$\sigma$ = ' + f'{s}' + '\n' +
    r'$\mu$ = ' + f'{m}' + '\n' +
    'Parámetros para el ruido convolucionado:' + '\n' +
    r'$\sigma$ = ' + f'{sc}' + '\n' +
    r'$\mu$ = ' + f'{mc}' + '\n' +
    f'La variación entre la desviación antes y después de la convolución es: {sc/s}'
)
